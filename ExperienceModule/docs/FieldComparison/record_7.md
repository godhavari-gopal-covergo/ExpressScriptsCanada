# Record Type 7 – Client Batch Control Record

## Module Coverage
- **Health**: Client Batch Control Record
- **Pharmacy**: Payee Batch Control Record
- **Dental**: Client Batch Control Record
- **DentalPreD**: Client Batch Control Record
...
| 3 | Filler | ✓ | 008 | X(4455) | ✓ | 005 | X(727) | ✓ | 008 | X(4455) | ✓ | 006 | X(1160) |
